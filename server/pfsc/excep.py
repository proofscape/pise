...
class PECode:
    ...
    SPHINX_ERROR = 56
    MODULE_NAME_USED_WITH_MULTIPLE_EXTENSIONS = 57
    OPTION_NOT_SUPPORTED_WITH_BUILD_IN_GDB = 58
    BAD_MODULE_FILENAME = 59
    BUILD_DIR_AND_GRAPH_DB_OUT_OF_SYNC = 60
    ...
    MALFORMED_DOC_REF_CODE = 178
    DOC_COMBINER_CODE_UKNOWN_VERS = 179
    MISSING_DOC_INFO = 180
    CANNOT_RESOLVE_NODE_LINK_TARGET = 181
    MALFORMED_DOMAIN_POLICY = 182
    MALFORMED_DOC_ID = 183
